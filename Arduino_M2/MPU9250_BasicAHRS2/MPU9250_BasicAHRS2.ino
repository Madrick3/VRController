...
{   
  ...
  if (delt_t > 100) { // print data at 10Hz (=100ms)
    ...
    teapotPacket[19]++; // packetCount, loops at 0xFF on purpose                     
      ...
      Serial.print(roll, 2);
      Serial.println(F(""));
      //delay(5); //for freepie timing
    #else  // for serial debug output if we are not doing teapot or freepie
      if(SerialDebug) {
...
void magcalMPU9250(float * dest1, float * dest2) 
{
  ...
  //    Serial.println("mag z min/max:"); Serial.println(mag_max[2]); Serial.println(mag_min[2]);
   ...
   #else
    dest1[0] = 440.43;
    dest1[1] = 224.35; //Store mag bias in G not mG
    dest1[2] = 191.55;    
    dest2[0] = 1.02;
    dest2[1] = 0.74;
    dest2[2] = 1.5;
