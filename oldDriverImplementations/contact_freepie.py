...
def updateTrackIR():
    trackIR.yaw = (yaw - centerYaw) * TRACKIR_MULTIPLIER*(-1)
    trackIR.pitch = (pitch - centerPitch) * TRACKIR_MULTIPLIER*(-1)
    trackIR.roll = (roll - centerRoll) * TRACKIR_MULTIPLIER*(-1)
